...
| Craft requirements | typography, color, anti-ai-slop, animation-discipline |

Trigger phrases: gpt taste, codex frontend taste, gsap motion landing, premium
codex UI.

Example brief: *Build a high-variance landing page with gpt-taste — editorial
typography, non-generic layout, calibrated colour, and tasteful GSAP-style
motion where the stack supports it.*

## Provenance

Vendored from `taste-skill` by Leonxlnx (MIT) —
https://github.com/Leonxlnx/taste-skill. The upstream MIT licence and
copyright notice are preserved in `LICENSE` in this directory.
